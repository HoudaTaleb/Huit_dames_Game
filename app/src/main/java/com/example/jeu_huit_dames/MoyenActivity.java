...
public class MoyenActivity extends AppCompatActivity {
        ...
        void affecter_reine(int lig, int col) {
            ...
            if (positions_reines[lig][col] == 1) {
                ...
                if (verification1()) {
                    ...
                    // Sélectionner les lignes, colonnes et diagonales invalides


                    // Créer une boîte de dialogue d'alerte
                    AlertDialog.Builder builder = new AlertDialog.Builder(MoyenActivity.this, R.style.AlertDialogStylealerte);
    ...
    private void interface_affecter_reine(int lig, int col) {
        ...
        Toast.makeText(MoyenActivity.this, "Nombre de cases valides restantes : " + casesValidesRestantes, Toast.LENGTH_SHORT).show();
